...
from app.api.graphql.contact.mutations import ContactMutation
...
@strawberry.type
class Mutation(UserMutation, StoreMutation, ProductMutation, OrderMutation, AnalyticsMutation, ContactMutation):
    pass
